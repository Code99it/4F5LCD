#ifndef FONT_PT_SANS_24PX_WHITE_H
#define FONT_PT_SANS_24PX_WHITE_H
...
int font_PT_Sans_24px_white_get_char_width(char c);
const uint16_t *font_PT_Sans_24px_white_get_char(char c);

extern const FontChar font_std[];
extern const int font_std_len;
...
extern const uint16_t char_PT_Sans_24_white_space[144];
